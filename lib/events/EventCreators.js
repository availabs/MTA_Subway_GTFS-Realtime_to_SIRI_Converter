...
module.exports = {
    ...
    emitTrainTrackingError : function (debugging_info) {
        eventEmitter.emit(eventEmitter.eventTypes.TRAIN_TRACKING_ERROR, debugging_info) ;
    } ,

    emitError : function (errorEvent) {
        eventEmitter.emit(eventEmitter.eventTypes.ERROR, errorEvent) ;
    } ,
