 ...
 */
function Converter (GTFS, GTFSrt, config, previousSnapshotInitializer) {
    ...
    try {
        ...
        this.trainTrackerSnapshot = new TrainTracker.newSnapshot(GTFS, GTFSrt, config, previousSnapshotInitializer);
    } catch (e) {
