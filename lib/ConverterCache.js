...
ConverterCache.prototype.getStopMonitoringResponse = function (getParams, dataFormat, callback) {
    ...
    includeSituationExchangeDelivery = !!this.stopsWithAlertsFilterObject[route_id];
    ...
    buildResponse.call(this, requestedTrains, 'stopMonitoring', stopMonitoringDetailLevel, 
                       maxOnwardCalls, stop_id, includeSituationExchangeDelivery,
...
ConverterCache.prototype.getVehicleMonitoringResponse = function (getParams, dataFormat, callback) {
    ...
    buildResponse.call(this, requestedTrains, 'vehicleMonitoring', 
                       vehicleMonitoringDetailLevel, maxOnwardCalls, null, includeSituationExchangeDelivery,
    ...
    function finito (err, respBuffer, offset) {
        ...
        if (err) {
            ...
            try {
                ...
                if (offset !== respBuffer.length) { console.log('%%%%%%%%%%%%%%%%%%%%%%%%% Offset != buffer length %%%%%%%%%%%%%%%%%%%%%%%%'); }
...
function bufferSituationExchange (converter, situationExchangeDelivery) {
    return {
        situationExchangeDelivery : {
            json : new Buffer(JSON.stringify(situationExchangeDelivery)),
