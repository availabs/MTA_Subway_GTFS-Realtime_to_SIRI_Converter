...
ConverterCache.prototype.getStopMonitoringResponse = function (getParams, dataFormat, callback) {
    ...
    requestedTrains = queryProcessor.getRequestedTrainsForStopMonitoringResponse.call(this, stop_id, getParams);
    ...
    responseBuilder.buildResponse.call(this, requestedTrains, 'stopMonitoring', stopMonitoringDetailLevel, 
...
ConverterCache.prototype.getVehicleMonitoringResponse = function (getParams, dataFormat, callback) {
    var getParams                    = getParams || {}  /* jshint ignore:line */             ,
        ...
        requestedTrains              = queryProcessor.getRequestedTrainsForVehicleMonitoringResponse
                                                     .call(this, getParams),
        includeSituationExchangeDelivery;
    ...
    responseBuilder.buildResponse.call(this, requestedTrains, 'vehicleMonitoring', vehicleMonitoringDetailLevel, 
                           maxOnwardCalls, null, includeSituationExchangeDelivery, dataFormat, 
                           responseHandler.bind(null, 'vehicleMonitoring', callback, dataFormat, getParams));
};
