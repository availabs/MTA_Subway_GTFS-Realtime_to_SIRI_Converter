...
var perJourney = {
    ...
    xml : {
        ...
        endNonemptyOnwardCalls   : new Buffer('</OnwardCall></OnwardCalls></VehicleActivity>'),

        emptyOnwardCalls : new Buffer('</MonitoredCall><OnwardCalls></OnwardCalls></VehicleActivity>'),
    }
};
