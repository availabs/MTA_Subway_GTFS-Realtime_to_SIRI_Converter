...
var perJourney = {
    ...
    stopMonitoring : {
      ...
      xml : {
          ...
          startNonemptyOnwardCalls : new Buffer('</MonitoredCall><OnwardCalls>'),
          endNonemptyOnwardCalls   : 
            new Buffer('</OnwardCalls></MonitoredVehicleJourney></MonitoredStopVisit>'),
    ...
    vehicleMonitoring : {
      ...
      xml : {
          ...
          startNonemptyOnwardCalls : new Buffer('</MonitoredCall><OnwardCalls>'),
          endNonemptyOnwardCalls   : 
            new Buffer('</OnwardCalls></MonitoredVehicleJourney></VehicleActivity>'),
