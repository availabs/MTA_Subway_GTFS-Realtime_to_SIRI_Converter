...
function inferLocations (GTFS, GTFSrt) {
    ...
    eventsCreator.emitLocationInferringStats(GTFSrt, result, unscheduledTrips, noSpatialDataTrips);
...
//}
    ...
    try {
        ...
        // for making this function's scope variables accessible to the eventsCreator.
        context.error = e;
        ...
        eventsCreator.emitTrainTrackingErrors(context);
