...
function inferLocations (GTFS, GTFSrt) {
    ...
    console.log("!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!");
    console.log("Unscheduled:", JSON.stringify(unscheduledTrips, null, 4));
    console.log("No Spatial:", JSON.stringify(noSpatialDataTrips, null, 4));
    console.log("!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!");
    ...
    try {
        ...
        if ( (state.AT_STOP) && 
            ...
            if ( !state.HAS_MOVED ) { 
                ...
                if (!state.AT_STOP) { console.log("(((((( NOT AT STOP ))))))"); }
