    ...
    try {
        ...
        if ( (state.AT_STOP) && 
            ...
            if ( !state.HAS_MOVED ) { 
                ...
                if ((isNaN(ratioCovered)) || (ratioCovered < 0) || (ratioCovered > 1)) {
                    console.log('%%%%%%%%%% Invalid Ratio Covered %%%%%%%%%%');
                    ...
                    console.log('onward stop:', GTFSrt.getNthOnwardStopTimeUpdateForTrip(trip_id, 0));
                }
...
if ((originStopId === null) || (destinationStopId === null)) {
    console.log('=====> originStopId:', originStopId, ',', destinationStopId) ;
    console.log(gtfsTripKey) ;
}
