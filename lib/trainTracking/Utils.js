...
module.exports = {
    ...
    // TODO: Verify that these assumptions are sound.
    //if (!stopInfo.atStop) {

        //allAgencyIDs = GTFS.getAllAgencyIDs() ;
        //isMTASubway  = (Array.isArray(allAgencyIDs) && (allAgencyIDs[0] === 'MTA NYCT')) ;

        //if (isMTASubway) { 
            //wasAssignedATrain = (GTFSrt.tripWasAssignedATrain) ? GTFSrt.tripWasAssignedATrain(trip_id) : null;

            //if (((wasAssignedATrain !== null) && (!wasAssignedATrain)) || !stopInfo.eta) {
