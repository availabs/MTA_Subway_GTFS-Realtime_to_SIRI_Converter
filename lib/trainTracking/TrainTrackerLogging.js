    ...
    try {
        ...
        if ( ctx.state.BAD_ETA ) {
            debugging_info = {
                ...
                immediateNextStopETA : (ctx.immediateNextStop && +ctx.immediateNextStop.eta) ? 
                                           timeUtils.getTimestamp(+ctx.immediateNextStop.eta) : null ,
        ...
        if (ctx.state.NO_STOP_TIME_UPDATES) { ctx.immediateNextStop = 'DOES_NOT_EXIST'; }
        ...
        debugging_info = {
            ...
            immediateNextStop     : ctx.immediateNextStop ,
            prevImmediateNextStop : (ctx.previous) ? (ctx.previous.immediateNextStop) : null ,
            ...
            prevPositionTimestamp : (ctx.previous && +ctx.previous.positionTimestamp) ? 
                                        ...
                                        null ,
            immediateNextStopETA  : (ctx.immediateNextStop && ctx.immediateNextStop.eta) ? 
                                        timeUtils.getTimestamp(+ctx.immediateNextStop.eta) : 
                                        null ,
