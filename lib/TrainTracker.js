...
function inferTrainLocation (GTFS, GTFSrt, trip_id) {
    ...
    try {
        ...
        console.error('ERROR: while tracking', gtfsTripKey);
        ...
        (function () {
            ...
            var debugging_info = {
                ...
                prevPositionTimestamp : (previous) ? previous.positionTimestamp : null               ,
...
function getStateOfTrain (GTFSrt, trip_id, stopTimeUpdates, previous) {
    ...
    state.AT_ORIGIN = (!state.WAS_ASSIGNED_TRAIN) || (stopTimeUpdates[0].eta === null);
