 ...
 */
function newSnapshot (GTFSrt, GTFSHandler) {
    ...
    if ( ! GTFSHandler ) { throw 'Empty GTFSHandler passed to TrainTracker.newSnapshot.'; }
    ...
    thisSnapshot = new Snapshot(GTFSrt, GTFSHandler);
...
function Snapshot (GTFSrt, GTFSHandler) {

    this.timestamp = GTFSrt.getTimestamp();

    this.trainLocations = inferLocations(GTFSrt, GTFSHandler);
}
...
function inferLocations (GTFSrt, GTFSHandler) {
    var allTrips        = GTFSrt.getAllMonitoredTrips(),
        locationInferer = inferTrainLocation.bind(null, GTFSrt, GTFSHandler);
...
function inferTrainLocation (GTFSrt, GTFSHandler, trip_id) {
