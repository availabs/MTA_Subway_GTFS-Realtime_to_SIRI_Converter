...
function GTFSRealtimeToSIRIConverter (GTFS, GTFSrt, config) {
   ...
   this.getVehicleMonitoringResponse.cache.__data__ = {};
}
 ...
 *  @see [The ResponseTimestamper]{@link ResponseTimestamper}
 */
GTFSRealtimeToSIRIConverter.prototype.getVehicleMonitoringResponse = _.memoize(function (getParams) {
...
function getValidUntil () {
    /*jshint validthis:true */
    var posixTimestamp = this.GTFSrt.getTimestamp() + _.get(this, ['config', 'gtfsrt', 'readInterval'], NaN);
