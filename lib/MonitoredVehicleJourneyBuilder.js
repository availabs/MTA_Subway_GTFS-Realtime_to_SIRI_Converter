...
function getMonitoredVehicleJourney (train_id) {
    ...
    var trip_id      = this.GTFSrt.trainIDToTripIDMap[train_id] ,
        ...
        gtfsTripKey  = this.GTFSrt.getGTFSTripKeyForRealtimeTripID(trip_id) ,
    ...
    mvj = {
        ...
        "FramedVehicleJourneyRef"  : getFramedVehicleJourneyRef.call(this, scheduleDate, gtfsTripKey) ,
 ...
 */
function getFramedVehicleJourneyRef (scheduleDate, gtfsTripKey) {
    /* jshint validthis: true */

    return {
        "DataFrameRef"           : getDataFrameRef(scheduleDate) ,
        "DatedVehicleJourneyRef" : getDatedVehicleJourneyRef.call(this, gtfsTripKey) ,
    };
}
...
function getDestinationRef (trip_id) {
    /* jshint validthis: true */
    var destinationID = this.GTFSrt.getDestinationIDForTrip(trip_id),
 ...
 */
function getDatedVehicleJourneyRef (gtfsTripKey) {
    /* jshint validthis: true */
