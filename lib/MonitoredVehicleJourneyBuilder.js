...
//var GTFSrt_Wrapper = require('MTA_Subway_GTFS-Realtime_Toolkit').Wrapper;
//var GTFS           = new GTFS_Wrapper(),
    //GTFSrt         = new GTFSrt_Wrapper();
 ...
 * @param {string} gtfsDataDir - path to the GTFS static data directory.
 */
function getMonitoredVehicleJourney (GTFSrt         ,
                                     GTFSHandler    ,
    ...
    GTFS            = GTFSHandler.getGTFSForTrip(trip_id)             ; //\\

    scheduleDate    = GTFSHandler.getScheduleDateForTrip(trip_id)     ; //\\
    ...
    mvj = {
        ...
        "OriginAimedDepartureTime" : getOriginAimedDepartureTime()                                   ,//TODO
        "SituationRef"             : getSituationRef()                                               ,//TODO
        "Monitored"                : getMonitored()                                                  ,//\\
        "VehicleLocation"          : getVehicleLocation(GTFS, GTFSrt, trainTrackerSnapshot, trip_id) ,//TODO
        "Bearing"                  : getBearing(GTFSrt, trip_id)                                     ,//TODO
 ...
 */
function getVehicleLocation (GTFS, GTFSrt, trainTrackerSnapshot, trip_id) { //TODO: This calls for a separate module.
    var location = trainTrackerSnapshot && trainTrackerSnapshot.getVehicleLocation(trip_id);

    return {
        "Longitude" : _.get(location, 'longitude', null) ,
        "Latitude"  : _.get(location, 'latitude', null)  ,
    };
}
 ...
 */
function getBearing (GTFS, GTFSrt, trainTrackerSnapshot, trip_id) {
    return (trainTrackerSnapshot && trainTrackerSnapshot.getBearing(trip_id)) || null;
}
