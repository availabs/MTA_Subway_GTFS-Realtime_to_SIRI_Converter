 ...
 */
function getMonitoredVehicleJourney (GTFS, GTFSrt, trainTrackerSnapshot, train_id) {
    ...
    mvj = {
        ...
        "OnwardCalls"              : getOnwardCalls(GTFS, GTFSrt, trainTrackerSnapshot, trip_id) ,
    };
 ...
 */
function getOnwardCalls (GTFS, GTFSrt, trainTrackerSnapshot, trip_id) { 
    var onwardStopIDs = GTFSrt.getOnwardStopIDsForTrip(trip_id) ;
