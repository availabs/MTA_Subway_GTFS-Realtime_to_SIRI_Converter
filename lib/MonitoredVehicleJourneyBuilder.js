...
function getVehicleLocation (trainTrackerSnapshot, gtfsTripKey) {
    return {
        "Latitude"  : trainTrackerSnapshot.getLatitude(gtfsTripKey)  ,
        "Longitude" : trainTrackerSnapshot.getLongitude(gtfsTripKey) ,
    };
}
...
function getBearing (trainTrackerSnapshot, gtfsTripKey) {
    return trainTrackerSnapshot.getBearing(gtfsTripKey);
}
 ...
 */
function getVehicleRef (train_id) {
    return (train_id) ? ('MTA ' + train_id) : null;
}
