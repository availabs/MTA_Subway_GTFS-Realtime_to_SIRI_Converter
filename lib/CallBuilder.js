...
function buildCall (GTFS, GTFSrt, trainTrackerSnapshot, trip_id, stop_id) { //TODO: Left-off here.
    return {
        "Extensions"            : { 
            "Distances" : getDistances(GTFS, GTFSrt, trainTrackerSnapshot, trip_id, stop_id), } ,//TODO
...
function getDistances (GTFS, GTFSrt, trainTrackerSnapshot, trip_id, stop_id) {
    ...
    return {
        PresentableDistance    : trainTrackerSnapshot.getPresentableDistance(trip_id, callDistanceAlongRoute_km, stopsFromCall) ,//TODO
        DistanceFromCall       : trainTrackerSnapshot.getDistanceFromCall(trip_id, stop_id)                                     ,//\\
