...
function getDistances (GTFS, GTFSrt, trainTrackerSnapshot, trip_id, stop_id) {
    ...
    return {
        PresentableDistance    : trainTrackerSnapshot && trainTrackerSnapshot.getPresentableDistance(tripKey, callDistanceAlongRoute_km, stopsFromCall) ,//\\
        DistanceFromCall       : trainTrackerSnapshot && trainTrackerSnapshot.getDistanceFromCall(tripKey, stop_id)                                     ,//\\
