...
function getDistances (trip_id, stop_id) {
    ...
    return {
        PresentableDistance    : this.trainTrackerSnapshot.getPresentableDistance(tripKey,
                                                                                  callDistanceAlongRoute_km, 
                                                                                  stopsFromCall),

        DistanceFromCall       : this.trainTrackerSnapshot.getDistanceFromCall(tripKey, stop_id),
